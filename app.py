...
class MediAIAssistant:
    ...
    def create_custom_css(self):
        """Add custom CSS styling for medical interface with increased font size for AI data."""
        st.markdown("""
            <style>
            ...
            .medical-container, .remedy-card, .health-tip-card, 
            .nutrition-card, .exercise-card, .sleep-card, .stress-card, .wellness-card {
                font-size: 1.2rem; /* Increased font size for AI-fetched data */
            }
            .medical-container {
                background: white;
                padding: 2rem;
    ...
    def render_homepage(self):
        ...
        st.image("https://media-hosting.imagekit.io/4aaa323e85d64ba2/ai3.jpg?Expires=1838825739&Key-Pair-Id=K2ZIVPTIP2VGHC&Signature=iBBCki0M45qfwWE62wovlaw4RHT9WNmUEIv-bMM-YhQHRJC13sivb9-8AyUZh~2j1fT2IqJLxWTcwpqDZLMGzWN1Z-UwJsANpuDNzIyYaGFzXaGwAQSCaUZeS5vmoDIHiW~08pKVliTUtVMkP1Go6XE1HdlXbSdQjN4Q7geqQ00i0xJBH1IVi4-ndazkQSPfnFpy1~8ozjDmiOWp7lz1m8PWjOooVmnABPeu6Z0fEPlDfyMZOWtMhWGSuYlGyliR9I9YdrZY1U3tv9VSE5k--CJATiO1v3KVaHHC4JfM7c7ButKX8uC~H9cKqPNGICCT8fwSn6YEFf0QGvlAIU4Y6g", use_container_width=True)
    ...
    def render_health_tips_page(self):
        """Render the health tips page with separate boxes for each tip category."""
        st.markdown("""
            <div class="medical-container">
        ...
        if generate_tips_button:
            ...
            if health_tips:
                # Split the health tips into sections
                sections = health_tips.split('\n\n')
                for section in sections:
                    if section.startswith("**Nutrition Tips:**"):
                        st.markdown("""
                        ...
                        st.markdown(section)
                        st.markdown("</div>", unsafe_allow_html=True)
                    elif section.startswith("**Exercise Tips:**"):
                        st.markdown("""
                        ...
                        st.markdown(section)
                        st.markdown("</div>", unsafe_allow_html=True)
                    elif section.startswith("**Sleep Tips:**"):
                        st.markdown("""
                        ...
                        st.markdown(section)
                        st.markdown("</div>", unsafe_allow_html=True)
                    elif section.startswith("**Stress Management Tips:**"):
                        st.markdown("""
                        ...
                        st.markdown(section)
                        st.markdown("</div>", unsafe_allow_html=True)
                    elif section.startswith("**General Wellness Notes:**"):
                        st.markdown("""
